...
void parar(){
  digitalWrite(IN1, LOW); //usar digitalwrite (high low etc...)
  digitalWrite(IN2, LOW);
  digitalWrite(IN3, LOW);
  digitalWrite(IN4, LOW);
}
void andar_para_frente(){
 digitalWrite(IN1, HIGH); //lado esquerdo
 digitalWrite(IN2, LOW);
 digitalWrite(IN3, HIGH); //lado direito
 digitalWrite(IN4, LOW);
}
...
void virar_direita_90_graus(){
  ...
  digitalWrite(IN2, LOW);
  digitalWrite(IN3, LOW);
  digitalWrite(IN4, LOW); // ou usar parar();
}
