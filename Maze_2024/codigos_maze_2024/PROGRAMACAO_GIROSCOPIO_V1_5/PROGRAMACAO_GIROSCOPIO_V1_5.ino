...
void loop(){
  ...
  if (acelerometro.available())
  {
    ...
    printOrientation();
    Serial.println("acelerometro detectado");
  } else {
    Serial.println("nenhum acelerometro foi detectado");
  }
}
...
void printOrientation(){
  ...
  {
  case LANDSCAPE_L:
    Serial.print("Paisagem Esquerda");//subindo
    //mudar velocidade dos motores para valores maiores
    break;
  case LOCKOUT:
    Serial.print("Plano");
    break;
