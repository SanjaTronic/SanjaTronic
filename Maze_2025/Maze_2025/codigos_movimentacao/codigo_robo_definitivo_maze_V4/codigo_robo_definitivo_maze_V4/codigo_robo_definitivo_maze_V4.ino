/*
========================================================================= ROBÔ DEFINITIVO MAZE V4.2 ========================================================================================
Autor: Murilo
Data da criação: 21/07/2025
Data da última modificação: 13/08/2025
...
int velMotoresEsq = 130;
int velMotoresDir = 185;
const int velMotoresEsqCurva = 200;
const int velMotoresDirCurva = 215;
...
const int grausGiroE = -82;
const int grausGiroD = 82;
...
void loop() {
  ...
  if (distUltrasonico > 6 && frente > 6) 
  {
    ...
    if (distUltrasonicoInicial - distUltrasonico >= 26 || distUltrasonico < 6) 
    {
    leituraCores();
  ...
  if (distUltrasonico < 6 || frente < 6) 
  {
    ...
    if ( (esquerda > 6 && esquerda > direita) || esquerda == -999) 
    {
      pararMotores();
      delay(1000);
      virarEsquerda90G();
    ...
    else if ( (direita > 6 && direita > esquerda) || direita == -999) 
    {
      pararMotores();
      delay(1000);
      virarDireita90G();
...
void cores() {
    ...
    if ((red > 32 && red < 70) && (green > 31 && green < 60) && (blue > 22 && blue < 38)) 
    {
    ...
    while (true) {
      ...
      if ((distAtual - distInicial >= 15) || (frenteAtual - frenteInicial >= 15)) {
        pararMotores();
        s_println("Distância aumentou 15cm. Parando.");
        delay(500);
        virarDireita90G();
        virarDireita90G();
        break;
  ...
  else if ((red > 27 && red < 42) && (green > 20 && green < 35) && (blue > 12 && blue < 20)) {
    Serial.println("AZUL");
    paraFrente();
    delay(800);
    pararMotores();
