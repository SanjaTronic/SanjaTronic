...
#define PinS2  6 //Definição do Pino S2 na entrada digital 9
#define PinS3 7 //Definição do Pinto S3 na entrada digital 10
...
void cores() { // funçao responsavel por definir a cor que o sensor de luminosidade está lendo
  ...
  else if ((red > 32 && red < 53) && (green > 31 && green < 47) && (blue > 22 && blue < 32)) { // detecção da cor preta
