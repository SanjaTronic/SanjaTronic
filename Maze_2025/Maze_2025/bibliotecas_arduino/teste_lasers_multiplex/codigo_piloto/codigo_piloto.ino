...
Data da última modificação: 25/06/2025
...
void loop() 
{
  ...
  seleciona_canal_multiplex(TCA1_END, END_PORTA_LASER1); // Seleciona o multiplex 1 no canal do primeiro sensor laser
  dist3 = leituraDistancia(laser1); // Recebe a distância capturada pelo sensor laser 1 na variável dist1
  Serial.print("distância2: ");
  Serial.print(dist2);
  Serial.print("cm");
  Serial.println("");
